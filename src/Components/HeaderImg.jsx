function HeaderImg() {
    return (
        <div className="h-fit md:h-[300px] grid grid-rows-2 w-full bg-[#152A46] md:flex md:justify-between md:px-[100px]">
            <div className="pt-5 md:pr-[200px] px-5 w-fit text-center md:text-left">
                <h2 className="text-white md:pt-4 md:w-[500px] md:text-[50px] text-3xl w-[400px] font-semibold leading-[50px]">Jadi expert bersama Agus Krisna</h2>
