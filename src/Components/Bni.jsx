export default function Bni({handleRadioChange, selectedValue}) {
    return (
        <>
            <div className="flex justify-between items-center px-2 h-12 md:flex md:justify-between md:w-[489px] md:h-14 md:mt-4 rounded shadow border border-neutral-300 md:px-3">
